...
env = default.create(
    portfolio=portfolio,
    action_scheme=default.actions.ManagedRiskOrders(stop=[0.02, 0.05, 0.1],
                                                    take=[0.02, 0.05, 0.1, 0.125, 0.15, 0.2]),
...
# %%
portfolio.performance[200]
# %%
portfolio.net_worth
# %%
plotly_renderer = default.renderers.PlotlyTradingChart()
# %%
plotly_renderer.render(env)
# %%
